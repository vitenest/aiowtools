...
return [
     ...
     * debugging.
     */
    'add_cache_time_header' => env('RESPONSE_CACHE_HEADERS', false),

    /**
     * This setting determines the name of the http header that contains
     * the time at which the response was cached
     */
    'cache_time_header_name' => env('RESPONSE_CACHE_HEADER_NAME', 'Cache-Date'),
     ...
     * the age of cache
     */
    'cache_age_header_name' => env('RESPONSE_CACHE_AGE_HEADER_NAME', 'Cache-Age'),
    ...
    'replacers' => [
        ...
        \App\Helpers\Classes\SessionFlashReplacer::class,
    ],
