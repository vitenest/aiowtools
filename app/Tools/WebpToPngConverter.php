...
class WebpToPngConverter implements ToolInterface
{
    public function render(Request $request, Tool $tool)
    {
        return view('tools.webp-to-png', compact('tool'));
    }
    ...
    public function handle(Request $request, Tool $tool)
    {
        $validated = $request->validate([
            ...
            'images.*' => "image|mimes:webp|max:" . $tool->fs_tool * 1024
        ]);
        ...
        return view('tools.webp-to-png', compact('results', 'tool'));
    }
