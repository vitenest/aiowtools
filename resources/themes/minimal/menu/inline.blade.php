    ...
    @foreach ($items as $item)
        @php
            ...
            if (isset($originalItem->child) && !$originalItem->child->isEmpty()) {
                if ($item->active) {
                    $linkAttributes = 'class="menu-link me-2 dropdown-toggle active" data-bs-toggle="dropdown"';
                } else {
                    $linkAttributes = 'class="menu-link me-2 dropdown-toggle" data-bs-toggle="dropdown"';
                }
                ...
                if ($item->active) {
                    $linkAttributes = 'class="menu-link me-2 active"';
                } else {
                    $linkAttributes = 'class="menu-link me-2"';
                }
