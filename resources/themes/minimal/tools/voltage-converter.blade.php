<x-application-tools-wrapper>
    ...
    <x-tool-wrapper :tool="$tool">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group mb-4">
                    <select name="from_unit" id="unit_1" required class="form-control form-select">
                        <option>Abcoulomb</option>
                        <option>Ampere hour (A hr)</option>
                        <option>Coulomb (Cb)</option>
                        <option>Faraday (F)</option>
                        <option>Microfaraday (mu-F)</option>
                        <option>Millifaraday (mF)</option>
                        <option>Picofaraday (pF)</option>
                        <option>Statcoulomb</option>
                    </select>
                </div>
            </div>
            <div class="col-md-6">
        ...
        <x-ad-slot class="mt-3" :advertisement="get_advert_model('above-form')" />
    </x-tool-wrapper>
    ...
    @push('page_scripts')
        <script>
            const APP = function() {
                ...
                factor[0] = new Array(10, 3600, 1, 96521.8999999997, 9.65219E-02, 96.5219, 9.65219E-05, .000000000333564);
