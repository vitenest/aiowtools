                 ...
                 <x-slot name="actions">
                     <div class="report-badges d-flex">
                         @if ($results['result']['count_section']['seo']['high'] > 0)
                             <span class="badge badge-danger rounded-pill ms-1">@lang('seo.highIssue', ['count' => $results['result']['count_section']['seo']['high']])</span>
                         @endif
                         @if ($results['result']['count_section']['seo']['medium'] > 0)
                             <span class="badge badge-warning rounded-pill ms-1">@lang('seo.mediumIssues', ['count' => $results['result']['count_section']['seo']['medium']])</span>
                         @endif
                         @if ($results['result']['count_section']['seo']['low'] > 0)
                             <span class="badge badge-info rounded-pill ms-1">@lang('seo.lowIssues', ['count' => $results['result']['count_section']['seo']['low']])</span>
                         @endif
                     </div>
                 </x-slot>
             @endif
                                                 ...
                                                 <li class="list-group-item">
                                                     <div class="d-flex justify-content-between"
                                                         ...
                                                         <p class="mb-0 text-uppercase">
                                                             {{ $key }}</p>
                                                         <span
                                                             class="badge badge-primary rounded-pill">{{ $header['count'] ?? '0' }}</span>
                                                     </div>
                                 ...
                                 <div class="mt-1">
                                     @if (count($results['result']['full_page']['keywords']) > 0)
                                         @foreach ($results['result']['full_page']['keywords'] as $keyword => $wordCount)
                                             <span class="badge badge-success rounded-pill">{{ $keyword }}
                                                 ({{ $wordCount }})
                                             </span>
                                         @endforeach
                                     @endif
                                     ...
                                     <ul class="list-group rounded-0 p-0 mt-3">
                                         <li class="list-group-item">
                                             <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                 ...
                                                 <span class="badge badge-primary rounded-pill">{{ $missing }}</span>
                                             </div>
                                             <div class="collapse" class="collapse multi-collapse px-3"
                                     ...
                                     @if ($results['result']['full_page']['links']['internal'] > 0)
                                         <li class="list-group-item">
                                             <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                 ...
                                                 <span
                                                     class="badge badge-primary rounded-pill">{{ $results['result']['full_page']['links']['internal'] ?? '0' }}</span>
                                             </div>
                                             <div class="collapse" class="collapse multi-collapse px-3"
                                     ...
                                     @if ($results['result']['full_page']['links']['external'] > 0)
                                         <li class="list-group-item">
                                             <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                 ...
                                                 <span
                                                     class="badge badge-primary rounded-pill">{{ $results['result']['full_page']['links']['external'] ?? '0' }}</span>
                                             </div>
                                             <div class="collapse" class="collapse multi-collapse px-3"
                                     ...
                                     <ul class="list-group rounded-0 p-0 mt-3">
                                         <li class="list-group-item">
                                             <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                 ...
                                                 <span
                                                     class="badge badge-primary rounded-pill">{{ $results['result']['full_page']['links']['nofollow'] ?? '0' }}</span>
                                             </div>
                                             <div class="collapse" class="collapse multi-collapse px-3"
                                     ...
                                     <ul class="list-group rounded-0 p-0 mt-3">
                                         <li class="list-group-item">
                                             <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                 ...
                                                 <span
                                                     class="badge badge-primary rounded-pill">{{ $results['result']['full_page']['links']['friendly'] ?? '0' }}</span>
                                             </div>
                                             <div class="collapse" class="collapse multi-collapse px-3"
                 ...
                 <x-slot name="actions">
                     <div class="report-badges d-flex">
                         @if ($results['result']['count_section']['performance']['high'] > 0)
                             <span class="badge badge-danger rounded-pill ms-1">@lang('seo.highIssue', ['count' => $results['result']['count_section']['performance']['high']])</span>
                         @endif
                         @if ($results['result']['count_section']['performance']['medium'] > 0)
                             <span class="badge badge-warning rounded-pill ms-1">@lang('seo.mediumIssues', ['count' => $results['result']['count_section']['performance']['medium']])</span>
                         @endif
                         @if ($results['result']['count_section']['performance']['low'] > 0)
                             <span class="badge badge-info rounded-pill ms-1">@lang('seo.lowIssues', ['count' => $results['result']['count_section']['performance']['low']])</span>
                         @endif
                     </div>
                 </x-slot>
             @endif
                                         ...
                                         @foreach ($results['result']['httpRequests']['requests'] as $key => $rqts)
                                             <li class="list-group-item">
                                                 <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                     ...
                                                     <p class="mb-0">{{ $key }}</p>
                                                     <span
                                                         class="badge badge-primary rounded-pill">{{ count($rqts) ?? '0' }}</span>
                                                 </div>
                                                 <div class="collapse" class="collapse multi-collapse px-3"
                                 ...
                                 <ul class="list-group rounded-0 p-0 mt-3">
                                     <li class="list-group-item">
                                         <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                             ...
                                             <span
                                                 class="badge badge-primary rounded-pill">{{ count($results['result']['imageFormats']) ?? '0' }}</span>
                                         </div>
                                         <div class="collapse" class="collapse multi-collapse px-3"
                                     ...
                                     <ul class="list-group rounded-0 p-0 mt-3">
                                         <li class="list-group-item">
                                             <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                 ...
                                                 <span
                                                     class="badge badge-primary rounded-pill">{{ count($results['result']['deferJs']) ?? '0' }}</span>
                                             </div>
                                             <div class="collapse" class="collapse multi-collapse px-3"
                     ...
                     <div class="col">
                         <div class="row">
                             ...
                             <div class="col-12 col-lg-8">
                                 ...
                                 <div class="mt-1">
                                     <span class="badge badge-success rounded-pill">{{ $results['result']['doctype'] }}</span>
                                 </div>
                             </div>
                         </div>
                     </div>
                 ...
                 <x-slot name="actions">
                     <div class="report-badges d-flex">
                         @if ($results['result']['count_section']['security']['high'] > 0)
                             <span class="badge badge-danger rounded-pill ms-1">@lang('seo.highIssue', ['count' => $results['result']['count_section']['security']['high']])</span>
                         @endif
                         @if ($results['result']['count_section']['security']['medium'] > 0)
                             <span class="badge badge-warning rounded-pill ms-1">@lang('seo.mediumIssues', ['count' => $results['result']['count_section']['security']['medium']])</span>
                         @endif
                         @if ($results['result']['count_section']['security']['low'] > 0)
                             <span class="badge badge-info rounded-pill ms-1">@lang('seo.lowIssues', ['count' => $results['result']['count_section']['security']['low']])</span>
                         @endif
                     </div>
                 </x-slot>
             @endif
                                     ...
                                     <ul class="list-group rounded-0 p-0 mt-3">
                                         <li class="list-group-item">
                                             <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                 ...
                                                 <span
                                                     class="badge badge-primary rounded-pill">{{ count($results['result']['plainEmails']) ?? '0' }}</span>
                                             </div>
                                             <div class="collapse" class="collapse multi-collapse px-3"
                             ...
                             <div class="col-12 col-lg-8">
                                 <p class="mb-0">
                                     {!! $results['result']['ssl']['is_valid'] == true
                                         ? __('seo.sslTestPassed', $results['result']['ssl'])
                                     ...
                                     <ul class="list-group rounded-0 p-0 mt-3">
                                         <li class="list-group-item">
                                             <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                 ...
                                                 <span
                                                     class="badge badge-primary rounded-pill">{{ count($results['result']['unsafeCOLinks']) ?? '0' }}</span>
                                             </div>
                 ...
                 <x-slot name="actions">
                     <div class="report-badges d-flex">
                         @if ($results['result']['count_section']['others']['high'] > 0)
                             <span class="badge badge-danger rounded-pill ms-1">@lang('seo.highIssue', ['count' => $results['result']['count_section']['others']['high']])</span>
                         @endif
                         @if ($results['result']['count_section']['others']['medium'] > 0)
                             <span class="badge badge-warning rounded-pill ms-1">@lang('seo.mediumIssues', ['count' => $results['result']['count_section']['others']['medium']])</span>
                         @endif
                         @if ($results['result']['count_section']['others']['low'] > 0)
                             <span class="badge badge-info rounded-pill ms-1">@lang('seo.lowIssues', ['count' => $results['result']['count_section']['others']['low']])</span>
                         @endif
                     </div>
                 </x-slot>
             @endif
                                     ...
                                     @if (count($results['result']['structuredData']['og'] ?? []) > 0)
                                         <li class="list-group-item">
                                             <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                 ...
                                                 <span
                                                     class="badge badge-primary rounded-pill">{{ count($results['result']['structuredData']['og'] ?? []) ?? '0' }}</span>
                                             </div>
                                             <div class="collapse" class="collapse multi-collapse px-3"
                                     ...
                                     @if (count($results['result']['structuredData']['twitter'] ?? []) > 0)
                                         <li class="list-group-item">
                                             <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                 ...
                                                 <span
                                                     class="badge badge-primary rounded-pill">{{ count($results['result']['structuredData']['twitter'] ?? []) ?? '0' }}</span>
                                             </div>
                                             <div class="collapse" class="collapse multi-collapse px-3"
                                     ...
                                     <ul class="list-group rounded-0 p-0 mt-3">
                                         <li class="list-group-item">
                                             <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                 ...
                                                 <span
                                                     class="badge badge-primary rounded-pill">{{ count($results['result']['structuredData']['schema'] ?? []) ?? '0' }}</span>
                                             </div>
                                             <div class="collapse" class="collapse multi-collapse px-3"
                                     ...
                                     <ul class="list-group rounded-0 p-0 mt-3">
                                         <li class="list-group-item">
                                             <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                 ...
                                                 <span
                                                     class="badge badge-primary rounded-pill">{{ count($results['result']['sitemaps']['sitemaps']) ?? '0' }}</span>
                                             </div>
                                             <div class="collapse" class="collapse multi-collapse px-3"
                                         ...
                                         @foreach ($results['result']['social'] as $key => $social)
                                             <li class="list-group-item">
                                                 <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                     ...
                                                     <p class="mb-0">{{ $key }}</p>
                                                     <span
                                                         class="badge badge-primary rounded-pill">{{ count($social) ?? '0' }}</span>
                                                 </div>
                                                 <div class="collapse" class="collapse multi-collapse px-3"
                                                     id="multiCollapseH_links_{{ $key }}">
                                                     <hr>
                                     ...
                                     <ul class="list-group rounded-0 p-0 mt-3">
                                         <li class="list-group-item">
                                             <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                 ...
                                                 <span
                                                     class="badge badge-primary rounded-pill">{{ count($results['result']['inlineCss']) ?? '0' }}</span>
                                             </div>
                                             <div class="collapse" class="collapse multi-collapse px-3"
                                         ...
                                         @foreach ($results['result']['depricatedtTags']['deprecatedTags'] as $tag => $count)
                                             <div
                                                 ...
                                                 <div class="tag-count"><span
                                                         class="badge badge-primary rounded-pill">{{ $count }}</span>
                                                 </div>
                                             </div>
                                         @endforeach
                                     </div>
                                     ...
                                     <ul class="list-group rounded-0 p-0 mt-3">
                                         <li class="list-group-item">
                                             <div class="d-flex justify-content-between" data-bs-toggle="collapse"
                                                 ...
                                                 <span
                                                     class="badge badge-primary rounded-pill">{{ count($results['result']['sitemaps']['disallow_rules']) ?? '0' }}</span>
                                             </div>
