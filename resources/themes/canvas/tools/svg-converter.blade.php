        ...
        <div class="tool-results-wrapper">
            ...
            <x-page-wrapper :title="__('common.result')">
                <div class="row">
                    ...
                    <div class="col-md-12 text-end">
                        <x-form class="d-none download-all-btn d-inline-block no-app-loader" metho="post"
            ...
            <script>
                const APP = function() {
                    ...
                    const process_id = '{{ $results['process_id'] }}',
                        files = {!! collect($results['files'])->pick('original_filename', 'size', 'filename')->toJson() !!},
                        max_files = 20,
                        ...
                        startConversion = async function(files, cursor) {
                                ...
                                await axios.post(route, {
                                    ...
                                    const cursorElem = document.querySelector(`#file-cursor-${cursor}`)
                                    cursorElem.innerHTML = '<span class="badge bg-danger">{{ __('common.failed') }}</span>'
                                })
